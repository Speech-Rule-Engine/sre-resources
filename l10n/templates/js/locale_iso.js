...
/**
 * @fileoverview ISO message file.
 *
 * @author volker.sorge@gmail.com (Volker Sorge)
 */
goog.provide('sre.Locale.ISO');

goog.require('sre.Locale');
goog.require('sre.Numbers.ISO');
...
sre.Locale.ISO = {
  ...
  NUMBERS: sre.Numbers.ISO.NUMBERS,
  ...
  ALPHABET_TRANSFORMERS: {
    digit: {
      default: function(n) {
        return n === 0 ? 'zero' : sre.Numbers.ISO.numberToWords(n);},
